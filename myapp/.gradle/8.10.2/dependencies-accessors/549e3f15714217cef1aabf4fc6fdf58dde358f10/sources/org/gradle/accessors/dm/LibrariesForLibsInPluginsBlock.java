...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>androidx.lottie</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>plugins</b> with <b>com.android.tools.build:gradle</b> coordinates and
         * with version reference <b>android.build.gradle</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidVersionAccessors extends VersionFactory  {
        ...
        private final AndroidBuildVersionAccessors vaccForAndroidBuildVersionAccessors = new AndroidBuildVersionAccessors(providers, config);
        public AndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.android.build</b>
         */
        public AndroidBuildVersionAccessors getBuild() {
            return vaccForAndroidBuildVersionAccessors;
        }

    }

    public static class AndroidBuildVersionAccessors extends VersionFactory  {

        public AndroidBuildVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>android.build.gradle</b> with value <b>8.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGradle() { return getVersion("android.build.gradle"); }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.lottie</b> with value <b>3.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLottie() { return getVersion("androidx.lottie"); }
    ...
    public static class AndroidxCoreVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.core.ktx</b> with value <b>1.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
