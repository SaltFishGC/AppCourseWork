/*
 ...
 Source Schema         : myapp_server

 Target Server Type    : MySQL
 Target Server Version : 50733 (5.7.33-log)
 File Encoding         : 65001

 Date: 01/06/2025 17:23:00
*/

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

CREATE DATABASE IF NOT EXISTS `myapp_server` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE `netem_full_list`  (
  ...
  `variant` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `topic` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
...
INSERT INTO `netem_full_list` VALUES (1438, 97, 'valuable', '有价值的、贵重的', NULL, NULL);
...
INSERT INTO `netem_full_list` VALUES (1449, 96, 'moreover', '而且、此外', NULL, 'communication');
...
INSERT INTO `netem_full_list` VALUES (1453, 96, 'suggestion', '建议', NULL, 'communication');
...
INSERT INTO `netem_full_list` VALUES (1533, 89, 'height', '高度、身高', NULL, 'describing things');
...
INSERT INTO `netem_full_list` VALUES (1550, 88, 'extent', '程度、范围', NULL, 'describing things');
...
INSERT INTO `netem_full_list` VALUES (1557, 87, 'solar', '太阳能的、太阳的', NULL, 'natural world');
...
INSERT INTO `netem_full_list` VALUES (4247, 8, 'disposition', '倾向、安排、性情', NULL, 'people: personality');
...
INSERT INTO `netem_full_list` VALUES (4307, 8, 'articulate', '善于表达的', NULL, NULL);
...
INSERT INTO `netem_full_list` VALUES (4754, 5, 'portfolio', '投资组合、作品集、文件夹', NULL, NULL);
...
INSERT INTO `netem_full_list` VALUES (5205, 1, 'interim', '临时的', NULL, NULL);
...
-- ----------------------------
-- Table structure for netem_learned_detail
-- ----------------------------
DROP TABLE IF EXISTS `netem_learned_detail`;
CREATE TABLE `netem_learned_detail`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `netem_learned_id` int(11) NOT NULL,
  `netem_learned_date` date NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_userid`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4864 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of netem_learned_detail
-- ----------------------------
INSERT INTO `netem_learned_detail` VALUES (4793, 11, 149, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4794, 11, 202, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4795, 11, 312, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4796, 11, 392, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4797, 11, 440, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4798, 11, 649, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4799, 11, 759, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4800, 11, 1028, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4801, 11, 1097, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4802, 11, 1126, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4803, 11, 1384, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4804, 11, 1535, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4805, 11, 1765, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4806, 11, 2433, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4807, 11, 2633, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4808, 11, 3062, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4809, 11, 3211, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4810, 11, 3510, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4811, 11, 3867, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4812, 11, 4282, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4813, 11, 5486, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4814, 12, 52, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4815, 12, 153, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4816, 12, 862, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4817, 12, 1190, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4818, 12, 1311, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4819, 12, 1334, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4820, 12, 1603, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4821, 12, 1905, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4822, 12, 1924, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4823, 12, 2240, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4824, 12, 2305, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4825, 12, 2332, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4826, 12, 2552, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4827, 12, 2672, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4828, 12, 3080, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4829, 12, 3723, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4830, 12, 3868, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4831, 12, 3930, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4832, 12, 3982, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4833, 12, 4056, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4834, 12, 4077, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4835, 12, 4134, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4836, 12, 4220, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4837, 12, 4259, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4838, 12, 4331, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4839, 12, 4528, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4840, 12, 4601, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4841, 12, 4638, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4842, 12, 4826, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4843, 12, 4827, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4844, 5, 562, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4845, 5, 1348, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4846, 5, 1380, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4847, 5, 1562, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4848, 5, 1636, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4849, 5, 1706, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4850, 5, 1879, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4851, 5, 2019, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4852, 5, 2410, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4853, 5, 2423, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4854, 5, 2529, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4855, 5, 2548, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4856, 5, 2780, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4857, 5, 3287, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4858, 5, 3518, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4859, 5, 4270, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4860, 5, 4368, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4861, 5, 4889, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4862, 5, 5030, '2025-05-27');
INSERT INTO `netem_learned_detail` VALUES (4863, 5, 5088, '2025-05-27');

-- ----------------------------
-- Table structure for time_learned
-- ----------------------------
DROP TABLE IF EXISTS `time_learned`;
CREATE TABLE `time_learned`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `time_learned` double NOT NULL,
  `time_learned_date` date NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_userid`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 582 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of time_learned
-- ----------------------------
INSERT INTO `time_learned` VALUES (530, 11, 0.25, '2025-05-12');
INSERT INTO `time_learned` VALUES (531, 11, 0.05, '2025-05-23');
INSERT INTO `time_learned` VALUES (532, 11, 0.016666666666666666, '2025-05-25');
INSERT INTO `time_learned` VALUES (533, 11, 0.16666666666666666, '2025-05-25');
INSERT INTO `time_learned` VALUES (534, 11, 0.16666666666666666, '2025-05-25');
INSERT INTO `time_learned` VALUES (535, 11, 0.016666666666666666, '2025-05-26');
INSERT INTO `time_learned` VALUES (536, 11, 0.4, '2025-05-27');
INSERT INTO `time_learned` VALUES (537, 11, 0.65, '2025-05-27');
INSERT INTO `time_learned` VALUES (538, 11, 0.13333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (539, 11, 0.05, '2025-05-27');
INSERT INTO `time_learned` VALUES (540, 11, 0.06666666666666667, '2025-05-27');
INSERT INTO `time_learned` VALUES (541, 11, 0.05, '2025-05-27');
INSERT INTO `time_learned` VALUES (542, 11, 0.08333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (543, 11, 0.03333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (544, 11, 0.016666666666666666, '2025-05-27');
INSERT INTO `time_learned` VALUES (545, 11, 0.016666666666666666, '2025-05-27');
INSERT INTO `time_learned` VALUES (546, 11, 0.05, '2025-05-27');
INSERT INTO `time_learned` VALUES (547, 11, 0.03333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (548, 12, 0.25, '2025-05-12');
INSERT INTO `time_learned` VALUES (549, 12, 0.05, '2025-05-23');
INSERT INTO `time_learned` VALUES (550, 12, 0.016666666666666666, '2025-05-25');
INSERT INTO `time_learned` VALUES (551, 12, 0.16666666666666666, '2025-05-25');
INSERT INTO `time_learned` VALUES (552, 12, 0.16666666666666666, '2025-05-25');
INSERT INTO `time_learned` VALUES (553, 12, 0.016666666666666666, '2025-05-26');
INSERT INTO `time_learned` VALUES (554, 12, 0.4, '2025-05-27');
INSERT INTO `time_learned` VALUES (555, 12, 0.65, '2025-05-27');
INSERT INTO `time_learned` VALUES (556, 12, 0.13333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (557, 12, 0.05, '2025-05-27');
INSERT INTO `time_learned` VALUES (558, 12, 0.06666666666666667, '2025-05-27');
INSERT INTO `time_learned` VALUES (559, 12, 0.05, '2025-05-27');
INSERT INTO `time_learned` VALUES (560, 12, 0.08333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (561, 12, 0.03333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (562, 12, 0.016666666666666666, '2025-05-27');
INSERT INTO `time_learned` VALUES (563, 12, 0.016666666666666666, '2025-05-27');
INSERT INTO `time_learned` VALUES (564, 12, 0.05, '2025-05-27');
INSERT INTO `time_learned` VALUES (565, 12, 0.03333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (566, 5, 0.25, '2025-05-12');
INSERT INTO `time_learned` VALUES (567, 5, 0.05, '2025-05-23');
INSERT INTO `time_learned` VALUES (568, 5, 0.016666666666666666, '2025-05-25');
INSERT INTO `time_learned` VALUES (569, 5, 0.16666666666666666, '2025-05-25');
INSERT INTO `time_learned` VALUES (570, 5, 0.16666666666666666, '2025-05-25');
INSERT INTO `time_learned` VALUES (571, 5, 0.016666666666666666, '2025-05-26');
INSERT INTO `time_learned` VALUES (572, 5, 0.4, '2025-05-27');
INSERT INTO `time_learned` VALUES (573, 5, 0.65, '2025-05-27');
INSERT INTO `time_learned` VALUES (574, 5, 0.13333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (575, 5, 0.05, '2025-05-27');
INSERT INTO `time_learned` VALUES (576, 5, 0.06666666666666667, '2025-05-27');
INSERT INTO `time_learned` VALUES (577, 5, 0.05, '2025-05-27');
INSERT INTO `time_learned` VALUES (578, 5, 0.08333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (579, 5, 0.03333333333333333, '2025-05-27');
INSERT INTO `time_learned` VALUES (580, 5, 0.016666666666666666, '2025-05-27');
INSERT INTO `time_learned` VALUES (581, 5, 0.016666666666666666, '2025-05-27');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, '123456', 'cdbc5334bcb59818fc861d1ac977e22a');
INSERT INTO `users` VALUES (2, '9815165', 'daa3e80bf42098aef0a71211eaeadbcc');
INSERT INTO `users` VALUES (3, '9841695', '78893e0ca8175e458dd9df3799ae7d29');
INSERT INTO `users` VALUES (4, '51', '78893e0ca8175e458dd9df3799ae7d29');
INSERT INTO `users` VALUES (5, '1', 'd84b85d4a1234d36c960ecb040a414fb');
INSERT INTO `users` VALUES (6, '1984', 'd84b85d4a1234d36c960ecb040a414fb');
INSERT INTO `users` VALUES (7, '1734374', 'd84b85d4a1234d36c960ecb040a414fb');
INSERT INTO `users` VALUES (8, '13', 'd84b85d4a1234d36c960ecb040a414fb');
INSERT INTO `users` VALUES (9, '12345', 'd84b85d4a1234d36c960ecb040a414fb');
INSERT INTO `users` VALUES (10, 'acd', 'd84b85d4a1234d36c960ecb040a414fb');
INSERT INTO `users` VALUES (11, '4274', 'd84b85d4a1234d36c960ecb040a414fb');
INSERT INTO `users` VALUES (12, '12', 'd84b85d4a1234d36c960ecb040a414fb');
